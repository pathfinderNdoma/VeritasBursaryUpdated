...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 md-12 ">
      ...
      <form method="GET" action="{{route('getPayslipPDF')}}">
        @csrf
        ...
        <div class="input-group ">
          ...
          <select type="text" name="month" id="month" class="form-control lineColor">
    ...
    {{-- <div class="form control">
          <input value='Generate Payslip' id="generate_slip" type="button" style="color:white" class="btn btn-primary form-control " />
    </div> --}}

    <div class="form control">
      <input value='Generate Payslip' id="" type="submit" style="color:white" class="btn btn-primary form-control " />
</div>
