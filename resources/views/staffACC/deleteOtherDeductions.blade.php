...
<!-- Modal -->
<div class="modal fade" id="deleteDeductions{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{route('deleteOtherDeductions', ['id'=>$data->id])}}"
