    ...
    <div class="modal-dialog  modal-dialog-top modal-fullscreen-xl-down">
      <div class="modal-content">
        <div class="modal-header" style="background-color:#198754; color:white; border: 1px #198754">
          <h5 class="modal-title" id="modalLabel" style="color:white">Add New Outgoing Donation</h5>
          <a href="#"><h4> <i class="bi bi-x-lg" data-bs-dismiss="modal" aria-label="Close" style="color:white"></i></h4></a>

        </div>
        <form name="form" method="POST" action="{{route('addoutgoingDonations')}}" enctype="multipart/form-data">
        <div class="modal-body">
            
          <div class="col-lg-12 col-md-12 col-xs-12">
            <label for="beneficiary">Beneficiary</label>
            <input type="text" name="beneficiary" id="beneficiary" class="form-control lineColor" required>
          </div> 
          <p></p>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
          ...
          <input type="file" name="donation_letter" id="donation_letter" class="form-control lineColor">
        </div> 
        <p></p>
