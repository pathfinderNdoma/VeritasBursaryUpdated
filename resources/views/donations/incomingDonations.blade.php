    ...
    <div id="content" class="p-4 md-12 ">
     ...
     @foreach ($donations as $data)
            ...
            <td>{{date('y-m-d', strtotime($data->donationDate))}}</td>
              ...
              <td>
                <a  href="/storage/donation_letters/{{$data->donationLetter}}" target="_blank"> <span type="button" 
                 class="fa fa-download btn" style="font-weight:700; font-size:20px; color:blue" >
                 </a>
                </td>

            <td>
              <a  href="/storage/payment_receipts/{{$data->paymentReceipt}}" target="_blank"> <span type="button" 
                class="fa fa-download btn" style="font-weight:700; font-size:20px; color:green" >
                </a>
            </td>

            <td>
              <a href="#"><span class="fa bi-pencil-square btn" style="font-weight:700; font-size:20px; color:blue" 
                data-bs-toggle="modal" data-bs-target="#updateDonations{{$data->id}}">
              </span>
              </a>
              @include('donations.updateIncomingDonations')
            </td>
            ...
            <td>
              ...
              @include('donations.deleteDonations')
            </td>
