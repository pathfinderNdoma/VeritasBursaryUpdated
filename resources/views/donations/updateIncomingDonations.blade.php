...
<div class="modal fade" id="updateDonations{{$data->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-top modal-fullscreen-xl-down">
    <div class="modal-content">
      ...
      <form name="form" method="POST" action="{{route('updateDonations')}}" enctype="multipart/form-data">
      ...
      <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <input type="file" name="update_donation_letter" id="donation_letter" class="form-control lineColor">
      </div> 
      <p></p>

      <div class="col-lg-12 col-md-12 col-xs-12 d-none">
        <label for="awardLetter">Donation Letter Val</label>
      ...
      <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <input type="file" name="update_payment_receipt" id="payment_receipt" class="form-control lineColor">
      </div> 
      <p></p>

      <div class="col-lg-12 col-md-12 col-xs-12 d-none">
        <label for="awardLetter">Upload payment receipt</label>
        <input type="text" name="update_payment_receiptVal" id="update_payment_receiptVal" class="form-control lineColor" value="{{$data->donationLetter}}">
      </div> 
      <p></p>

      <div class="col-lg-12 col-md-12 col-xs-12 d-none">
        <label for="updateID">ID</label>
        <input type="text" name="updateID" id="updateID" class="form-control lineColor" value="{{$data->id}}" >
      </div> 
      <p></p>
