  ...
  <div class="modal-dialog  modal-dialog-top modal-fullscreen-xl-down">
    <div class="modal-content">
      ...
      <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <input type="date" name="update_pledgeDate" id="update_pledgeDate" class="form-control lineColor" value="{{$data->pledgeDate}}">
      </div> 
      <p></p>

      <div class="col-lg-12 col-md-12 col-xs-12">
        <label for="redemptionDate">Redemption Date</label>
        <input type="date" name="update_redemptionDate" id="update_redemptionDate" class="form-control lineColor" value="{{$data->redemptionDate}}">
      </div> 
      <p></p>
