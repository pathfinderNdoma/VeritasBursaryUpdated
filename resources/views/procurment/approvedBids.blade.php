  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 md-12 ">
      ...
      <div class="col-md-4 col-xs-12 col-lg-4">
        ...
        <form method="GET" action="{{route('approvedContracts')}}" name="form" >
        @csrf  
        ...
        <table class="table table-striped" id="empTable" style="color:#000; font-size:13px;">
         ...
         <p class="d-none">{{$n=1}} </p>
          ...
          <tbody>
     @foreach ($approvedContracts as $data)
            <td>{{$n}}</td>
            ...
            @if ($data->contract_letter == '')
            <td>No letter to show</td>  
            @else
            <td><a href="/storage/contract_letters/{{$data->contract_letter}}" target="_blank">View Contract Letter</a></td>   
            @endif
            <td><a href="/storage/invoice/30848SQHB1.pdf" target="_blank">View details</a></td> 
