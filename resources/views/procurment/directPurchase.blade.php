  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 md-12 ">
      ...
      <div class="col-md-4 col-xs-12 col-lg-4">
        ...
        <form method="GET" action="{{route('fetchDirectPurchase')}}" name="form" >
        @csrf  
        <div class=" col-xs-12 col-lg-4 col-md-4">
          <input type="button" name="" value="Add Direct Purchase" class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#createContract">
        </div>
<hr>
     ...
     @foreach ($purchases as $data)
            <td>{{$n}}</td>
            <td>{{$data->itemName}}</td>
            <td>{{$data->itemNature}}</td>
            <td>{{$data->quantity}}</td>
            <td>&#x20A6;{{number_format($data->unitPrice)}}</td>
            <td>&#x20A6;{{number_format($data->totalPrice)}}</td>
            ...
            <td>
              <a  href="/storage/directPurchases_receipts/{{$data->receipt}}" target="_blank"> <span type="button"  
            ...
            <td>
              <a href="#"><span class="fa bi-pencil-square btn" style="font-weight:700; font-size:20px; color:blue" 
                data-bs-toggle="modal" data-bs-target="#updatePurchase{{$data->id}}"></span></a>
                @include('procurment.updateDirectPurchase')
            </td>
            ...
            <td>
              ...
              @include('procurment.deleteDirectPurchase')
              </td>           
...
@include('procurment.addDirectPurchase')
