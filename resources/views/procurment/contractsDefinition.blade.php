    ...
    <div id="content" class="p-4 md-12 ">
      ...
      <div class="col-md-4 col-xs-12 col-lg-4">
        ...
        <div class="row col-12">
          ...
          <div class="col-xs-12  col-lg-4 col-md-4 form-control">
            <input type="submit" name="generate" value="View Details" class="btn btn-success">
          </div>

          <div class=" col-xs-12 col-lg-4 col-md-4 text-right">
            <input type="button" name="" value="Contract Definition" class="btn btn-outline-primary"  data-bs-toggle="modal" data-bs-target="#contractDef">
          </div>
