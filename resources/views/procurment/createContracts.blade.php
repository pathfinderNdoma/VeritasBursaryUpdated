  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 md-12 ">
      ...
      <div class="col-md-4 col-xs-12 col-lg-4">
        ...
        <div class="row col-12">
          ...
          <div class=" col-xs-12 col-lg-4 col-md-4 text-right">
            <input type="button" name="" value="Create Contract" class="btn btn-outline-primary"  data-bs-toggle="modal" data-bs-target="#createContract">
          </div>
     ...
     @foreach ($contracts as $data)
            ...
            <td>{{$data->status}}</td>
            <td>
              <a href="{{route('viewContractDetails', ["contract_id"=>$data->contractID])}}" class="btn btn-sm btn-outline-primary">View Details</a>
            </td>

            <td>
              <a href="#"><span class="fa fa-sharp fa-regular fa-wrench btn" style="font-weight:700; font-size:20px; color:blue" 
              data-bs-toggle="modal" data-bs-target="#contractStatus{{$data->contractID}}"></span></a>
              @include('procurment.contractStatusModal')
              </td>           
...
@include('procurment.createContractModal')
