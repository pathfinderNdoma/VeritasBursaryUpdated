...
<div class="modal fade" id="updateAsset{{$data->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-top modal-fullscreen-xl-down modal-lg">
      <div class="modal-content">
        ...
        <form name="form" method="POST" action="{{route('updateAsset')}}" enctype="multipart/form-data">
...
{{-- ********************************************DIV FOR EQUIPMENT ASSETS STARTS********************************************************************************** --}}
  @if ($data->assetType=='equipment')
            ...
            <div class="row col-12">
                ...
                <div class="col-lg-6 col-md-6 col-xs-6">
                  ...
                  value="{{$data->purchaseBy}}"class="form-control lineColor" />
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-xs-6 d-nonen">
  ...
  <div id="building">
              ...
              <div class="col-lg-6 col-md-6 col-xs-6 d-none">
                ...
                <input type="text" name="update_building_ID" id="update_land_ID" value="{{$data->id}}" class="form-control lineColor"/>
              </div>
            </div><p></p>
...
{{-- ********************************************DIV FOR LAND ASSETS END********************************************************************************** --}}
    ...
    <div class="row col-12">  
      <div class="col-lg-12 col-md-13 col-xs-12">
        <label for="update_sightedBy" style="color:#198754; font-weight:bold">Sighted By</label>
        <input type="text" name="update_sightedBy" id="update_sightedBy" class="form-control lineColor" value="{{$data->sightedBy}}" required />
      </div>
  </div><p></p>
    ...
    <div class="row col-12">  
      <div class="col-lg-12 col-md-13 col-xs-12">
        ...
        <input type="text" name="update_sighteby_designation" id="update_sighteby_designation" 
        class="form-control lineColor" value="{{$data->sighteby_designation}}" required />
      </div>
  </div><p></p>
  ...
  <div class="row col-12">  
    <div class="col-lg-12 col-md-13 col-xs-12">
      ...
      <input type="date" name="update_dateofSightation" id="update_dateofSightation" class="form-control lineColor" value="{{$data->dateofSightation}}" required />
    </div>
  </div><p></p>
