  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 md-12 ">
     ...
     @foreach ($donations as $data)
            ...
            @else
            <td>
              <a  href="/storage/donation_letter/{{$data->paymentReceipt}}" target="_blank"> <span type="button"  class="fa fa-download btn" style="font-weight:700; font-size:20px; color:blue" ></a>
            </td>                 
              @endif
            {{-- CHecking if the donation letter was  --}}
            ...
            <td>
              <a  href="/storage/payment_receipts/{{$data->paymentReceipt}}" target="_blank"> <span type="button"  class="fa fa-download btn" style="font-weight:700; font-size:20px; color:blue" ></a>
              
            </td>

            <td>
              <a href="#"> <span type="button"  class="fa fa-edit btn" style="font-weight:700; font-size:20px; color:blue" data-bs-toggle="modal" data-bs-target="#update{{$data->id}}"></a>
