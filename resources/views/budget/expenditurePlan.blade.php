     ...
     @foreach ($budget as $data)
            ...
            <td>
              <a href="#"> <span type="button"  class="fa fa-edit btn" style="font-weight:700; font-size:20px; color:blue"
                 data-bs-toggle="modal" data-bs-target="#updateBudget{{$data->id}}"></a>
                @include('budget.updateExpenditure')
            </td>
            <td></span>
              <a href="#"><span class="fa fa-trash btn" style="font-weight:700; font-size:20px; color:red" data-bs-toggle="modal" 
                data-bs-target="#deleteBudget{{$data->id}}"></span>
              </a>
              @include('budget.deleteExpenditurePlan')
            </td>
        </tr>
        <p class="d-none">{{$n++}} </p> 
